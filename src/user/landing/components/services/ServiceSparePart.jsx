      ...
      <div className="flex flex-col gap-5 w-full md:w-1/2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-justify md:text-left">
            Benerin Motor menyediakan beragam spare part berkualitas, baik baru
            maupun second. Mulai dari rem, kampas kopling, lampu, hingga ban.
            Tersedia produk dengan harga bersahabat dan kualitas terjamin.
          </p>
        </div>
