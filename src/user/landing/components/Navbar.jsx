  ...
  const AuthButtons = () => (
    <>
      <Link
        ...
        className="border border-orange-500 duration-300 px-5 py-1.5 rounded-md hover:bg-orange-700"
      >
        Register
      </Link>
      <Link
        to="/login#login"
        className="border border-orange-500 bg-orange-500 duration-300 px-5 py-1.5 rounded-md hover:bg-orange-700"
      >
        Login
      </Link>
    </>
      ...
      <div className="bg-slate-900 px-3 lg:px-7">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex space-x-4 items-center">
            <Link
              ...
              className={`duration-300 hover:text-orange-500 ${
                activeLink === "/" ? "border-b-2 border-orange-500" : ""
              }`}
            >
              Home
            </Link>
            <Link
              to="/shop"
              className={`duration-300 hover:text-orange-500 ${
                activeLink === "/products" ? "border-b-2 border-orange-500" : ""
              }`}
            >
              Shop
            </Link>
            ...
            <Link
              to="/contact"
              className={`duration-300 hover:text-orange-500 ${
                activeLink === "/contact" ? "border-b-2 border-orange-500" : ""
              }`}
            >
              Contact
            </Link>
          ...
          <div className="md:hidden">
            <div
              onClick={toggleMenu}
              className="cursor-pointer focus:outline-none focus:text-blue-300 hover:text-blue-200"
            >
              <svg
                className="w-6 h-6"
                fill="none"
            ...
            <div className="bg-black bg-opacity-75 py-2 rounded-md">
              {user ? (
                <div className="px-3 py-2">
                  ...
                  <div
                    className={`mt-2 space-y-1 ${
                      isMobileUserMenuOpen ? "block" : "hidden"
                    }`}
                  >
                    <Link
                      to="/profile"
                ...
                <div className="flex items-center justify-center gap-2 py-2 px-3">
                  <Link
                    to="/register#register"
                    className="border border-orange-500 duration-300 px-3 py-1 rounded-md text-center w-full hover:bg-orange-700"
                  >
                    Register
                  </Link>
                  <Link
                    to="/login#login"
                    className="border border-orange-500 bg-orange-500 duration-300 px-3 py-1 rounded-md text-center w-full hover:bg-orange-700"
                  >
                    Login
                  </Link>
                </div>
              ...
              <Link
                to="/"
                className={`block py-2 px-3 duration-300 hover:text-orange-500 ${
                  activeLink === "/" ? "" : ""
                }`}
                onClick={toggleMenu}
              >
