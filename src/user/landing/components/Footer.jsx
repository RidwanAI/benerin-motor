    ...
    <footer id="footer" className="font-poppins text-white w-full">
      <div className="bg-slate-950">
        ...
        <div className="bg-slate-800 flex items-center justify-around py-5 text-white tracking-wider w-full">
          <p className="flex font-bold italic items-center text-md md:text-2xl">
            Terpecaya
          </p>
          <p className="flex font-bold italic items-center text-md md:text-2xl">
            Murah
        ...
        <div className="flex flex-col gap-10 items-center justify-center max-w-7xl mx-auto px-3 py-10 w-full md:flex-row md:px-7">
          ...
          <div className="flex flex-col gap-4 items-start justify-center w-full lg:w-1/2">
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              <p className="font-bold italic text-justify text-md">
            ...
            <div className="flex flex-col space-y-2 text-sm">
              <p className="text-justify">
                Pondok Ungu Permai Sektor V M6 No. 10, Kel. Bahagia, Kec.
                Babelan, Kab. Bekasi Utara, Jawa Barat.
              </p>
              <iframe
            ...
            <div className="flex flex-col space-y-2 text-sm w-full">
              ...
              <div className="w-full">
                <p
                  className="border border-orange-500 cursor-pointer flex font-semibold justify-between items-center p-3 rounded-md text-md"
                ...
                {isInfoOpen && (
                  <div className="flex flex-col text-sm space-y-2 py-5">
                    <a
                      href=""
                      className="duration-300 hover:px-4 hover:text-orange-500"
                    >
                      Tentang Kami
                    </a>
                    <a
          ...
          <div className="flex items-center justify-center w-full lg:w-1/2">
            <img
              src="../general/cartoonmontir.png"
              alt="cartoonmontir.png"
              width={250}
            />
          </div>
        </div>
