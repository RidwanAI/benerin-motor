            ...
            <div className="flex flex-col gap-4 items-start justify-center w-full">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-xl md:text-2xl">
                  Bengkel Motor Andalan, Solusi Kendaraan Prima!
                </p>
              </div>
              {/* End - Title */}
              ...
              <div className="flex gap-4">
                <Link
                  to={"/login"}
                  className="bg-orange-500 flex items-center gap-2 duration-300 px-3 py-1.5 rounded-md md:px-7 md:py-2 hover:bg-orange-700 hover:translate-x-2"
                >
                  <svg
              ...
              <div className="flex items-center gap-4">
                ...
                <a
                  href="https://www.instagram.com/benerin.motor/"
                  className="duration-300 hover:bg-orange-700 hover:p-3 hover:rounded-full"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="23"
        ...
        <div className="bg-slate-900">
          <div className="flex flex-col gap-10 items-center justify-center max-w-7xl mx-auto px-3 py-20 w-full md:px-7">
            ...
            <div className="border border-orange-500 p-3 rounded-md space-y-1 text-justify">
              ...
              <p>
                Benerin Motor menyediakan layanan perbaikan dan pemeliharaan
                sepeda motor yang profesional, cepat, dan berkualitas tinggi.
                Dengan dukungan teknisi berpengalaman, kami siap menangani
                berbagai kebutuhan motor Anda—dari perawatan rutin hingga
                perbaikan mendalam. Selain itu, kami menyediakan beragam pilihan
                spare part berkualitas, baik baru maupun second, yang dapat
                diandalkan untuk menjaga performa kendaraan Anda. Fokus utama
                kami adalah memberikan layanan terbaik dengan harga bersahabat,
                mengutamakan kepuasan pelanggan, dan memastikan motor Anda
                selalu dalam kondisi optimal. Percayakan perawatan motor Anda
                kepada Benerin Motor, dan rasakan pengalaman berkendara yang
          ...
          <div className="flex flex-col gap-10 items-center justify-center max-w-7xl mx-auto px-3 py-20 w-full md:px-7">
            ...
            <div className="flex flex-col items-center justify-center md:items-end md:justify-end md:text-end">
              <p className="font-semibold text-xl md:text-2xl">
                Our Services, Benerin{" "}
                <span className="text-orange-500">Motor</span>
              </p>
            </div>
            {/* End - Title */}
            ...
            <div className="flex flex-col items-start justify-center gap-10 rounded-md shadow-lg w-full md:gap-4 md:flex-row">
              <div className="border border-orange-500 flex flex-col items-center justify-center rounded-md w-full md:w-72">
                <Link
                  ...
                  className={`${
                    services === "srb"
                      ? "active bg-orange-500 flex italic items-center justify-center text-center text-white"
                      : "duration-300 flex items-center justify-center text-center hover:text-white hover:bg-orange-700"
                  } px-2 py-2 w-full `}
                >
                  Service Rutin ~ Besar
                </Link>
            ...
            <div className="flex gap-4 items-start justify-center w-full">
              ...
              <div className="flex flex-col gap-2 items-start justify-center w-full md:w-1/2">
                ...
                <p>
                  Masih ragu pelayanan kami? Jangan khawatir, cepat perbaiki
                  motor kalian di Benerin Motor!
                </p>
                <hr className="border border-orange-500 w-full" />
                <div className="flex gap-2 text-sm">
                  <a
                    href="https://wa.me/6289515996476?text=Halo%2C+saya+ingin+berkonsultasi.+Terimakasih"
              ...
              <div className="flex flex-col gap-4 items-center justify-center w-full md:w-1/2">
                ...
                <div className="">
                  ...
                  <Link
                    ...
                    className="border border-orange-500 bg-orange-500 duration-300 flex items-center gap-2 px-3 py-1 rounded-md md:px-5 md:py-1.5 hover:bg-orange-700 cursor-pointer"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      ...
                      <div className="bg-slate-800 rounded-lg p-5 w-full md:w-1/2">
                        ...
                        <div className="flex justify-end space-x-3">
                          <button
                            ...
                            className="bg-white duration-300 px-3 py-1 rounded-md text-black md:px-5 md:py-1.5 hover:bg-gray-200"
                          >
                            Cancel
                          </button>
                          <button
                            onClick={handleSubmitTestimoni}
                            className="bg-orange-500 duration-300 px-3 py-1 rounded-md text-white md:px-5 md:py-1.5 hover:bg-orange-700"
                          >
                            Submit
                          </button>
                        </div>
