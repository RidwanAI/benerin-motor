          ...
          <div className="flex flex-col gap-4 items-center justify-center max-w-7xl min-h-screen mx-auto px-3 w-full md:px-7">
            ...
            <div className="flex flex-col gap-4 items-start justify-center w-full">
              ...
              <div className="flex gap-4">
                <Link to={"/login"} className="bg-orange-500 flex items-center gap-2 duration-300 px-3 py-1.5 rounded-md md:px-7 md:py-2 hover:bg-orange-700 hover:translate-x-2">
