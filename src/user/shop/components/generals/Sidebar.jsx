    ...
    <div className="font-poppins flex">
      ...
      <div className={`fixed top-0 left-0 h-screen bg-slate-900 text-white transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"} w-60 md:w-72 z-50 flex flex-col`}>
        ...
        <div className="mt-auto p-3">
          <button onClick={handleAuthAction} className={`duration-300 flex gap-2 items-center justify-center px-3 py-1.5 rounded-md w-full md:px-5 md:py-1.5 ${user ? "bg-red-500 hover:bg-red-700" : "bg-green-500 hover:bg-green-700"}`}>
            {user ? (
              <>
