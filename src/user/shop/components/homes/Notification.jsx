...
const Notification = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      title: "Big Sale Coming Up!",
      content:
        "Huge discounts are arriving soon! Stay tuned for our big sale event this weekend.",
      read: false,
    },
    {
      id: 2,
      title: "10% Discount on First Purchase",
      content:
        "Use the code NEW10 at checkout to get 10% off on your first purchase.",
      read: false,
    },
    {
      id: 3,
      ...
      content:
        "Enjoy free shipping on all orders over $50. Don't miss out on this amazing offer!",
      read: false,
    },
    {
      id: 4,
      title: "20% Discount on Selected Products",
      content: "Selected products are now 20% off. Limited time only!",
      read: false,
    },
  ]);
    ...
    <section>
      ...
      <div className="fixed bottom-3 right-3 z-50 md:right-7">
        <button
          ...
          className="relative bg-orange-500 duration-300 p-3 rounded-md text-white hover:bg-orange-700"
        >
          <svg
          ...
          {unreadCount > 0 && (
            <span className="absolute bg-red-500 font-monserrat px-1 right-0.5 rounded-full text-white text-xs top-0.5">
              {unreadCount}
            </span>
          )}
        </button>
          ...
          <div className="bg-black bg-opacity-75 fixed flex inset-0 items-center justify-center p-3 space-y-3 z-50">
            <div className="bg-white p-4 relative rounded-md shadow-sm w-full md:max-w-md">
              ...
              <button
                ...
                className="mt-4 w-full bg-orange-500 text-white px-4 py-2 rounded-md"
              >
                Close
              </button>
            </div>
