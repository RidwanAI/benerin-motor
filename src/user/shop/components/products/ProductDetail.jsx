  ...
  if (!product) {
    return (
      <div className="bg-orange-200 flex flex-col font-poppins gap-2 h-screen items-center justify-center p-3 text-center">
        <p className="font-bold text-red-500 text-xl md:text-2xl">
          Product not found!
        </p>
    ...
    if (isAuthenticated) {
      ...
      return (
        <button
          ...
          className="w-full bg-blue-500 duration-300 px-3 py-1.5 rounded-md text-white hover:bg-blue-700 md:px-5 md:py-1.5"
        >
          Login to Buy
        </button>
      );
