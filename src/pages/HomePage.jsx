...
const HomePage = () => {
  return (
    <Layout>
      {/* Section -Home */}
      <section id="home" className="font-raleway text-white tracking-wider">
        {/* Title */}
        <div className="bg-home flex flex-col gap-4 items-center justify-center px-3 py-44 text-center w-full lg:px-7">
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <p className="font-semibold text-4xl md:text-6xl">
              Benerin <span className="text-orange-500">Motor</span>
            </p>
            <p className="text-2xl">Bengkel Motor Andalan, Solusi Kendaraan Prima!</p>
            <hr className="border-2 w-full" />
            <div className="flex gap-4">
              <Link to={"/"} className="bg-orange-500 duration-300 px-3 py-1 rounded-md hover:bg-orange-700 hover:-translate-x-1">
                Contact Us
              </Link>
              <Link to={"/"} className="bg-orange-500 duration-300 px-3 py-1 rounded-md hover:bg-orange-700 hover:translate-x-1">
                Booking List
        ...
        {/* Dashboard */}
        <div className="bg-orange-700 flex font-semibold gap-4 items-center justify-between px-3 py-5 text-center w-full lg:px-7">
          <div className="flex flex-col items-center justify-center w-full">
            <p>Years of Experience</p>
            <p className="flex items-center gap-2">
              <ConstPortfolioComponent target={5} duration={2000} />
            </p>
          </div>
          <div className="flex flex-col items-center justify-center w-full">
            <p>Number of Motorcycles</p>
            <p className="flex items-center gap-2">
              <ConstPortfolioComponent target={45} duration={2000} />
            </p>
          </div>
          <div className="flex flex-col items-center justify-center w-full">
