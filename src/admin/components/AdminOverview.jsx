          ...
          <div className="space-y-3">
            ...
            <div className="gap-3 grid grid-cols-2 w-auto lg:grid-cols-4">
              ...
              <button
                ...
                className="bg-white duration-300 flex flex-col rounded-sm p-3 shadow-sm space-y-3 transition-transform transform hover:scale-95 hover:shadow-lg"
              >
                <div className="flex flex-col gap-3 items-center justify-center w-full md:flex-row md:justify-start">
                  ...
                  <div className="flex flex-col items-center md:items-start">
                    <p className="font-bold text-slate-700 text-2xl">
                      {productCount}
                    </p>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-slate-700 text-sm leading-relaxed">
                    Track and manage all product data in the system. This
                    includes inventory levels, product details, and more to keep
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-slate-700 text-sm leading-relaxed">
                    {" "}
                    Manage all customer data including personal information,
                    purchasing history, and more to enhance customer
              ...
              >
                ...
                <div className="space-y-3">
                  <hr className="w-full" />
                  <p className="text-slate-700 text-sm leading-relaxed">
                    Monitor and manage all customer orders, including order
                    status, payment details, and delivery tracking to streamline
                    operations.
                  </p>
                </div>
              </button>
            ...
            <div className="gap-3 grid grid-cols-2 w-auto lg:grid-cols-4">
              ...
              >
                ...
                <div className="space-y-3">
                  <hr className="w-full" />
                  <p className="text-slate-700 text-sm leading-relaxed">
                    Track and manage all booking details, including schedules,
                    customer requests, and confirmations to ensure seamless
                    operations.
                  </p>
                </div>
              </button>
